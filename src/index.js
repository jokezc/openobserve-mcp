...
const server = new McpServer(
  ...
  },
  {
    instructions: [
      ...
      "If a trace ID appears in logs or user input, pivot to get_trace_summary and correlate_logs_and_traces. Set includeTraceDag=true on get_trace_summary only when the trace summary is insufficient.",
      ...
      "Use top_errors, analyze_log_patterns, analyze_log_topk, or analyze_log_timeline only for broad scans such as 'what are the main errors recently', not for targeted lookups driven by IDs or exact keywords.",
